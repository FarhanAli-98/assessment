...
import 'package:nomixe/data/domain/models/response.dart' as response;
import 'package:nomixe/data/exceptions/http_exception.dart';
import 'package:nomixe/data/remote/network_service.dart';

mixin ExceptionHandlerMixin on NetworkService {
  Future<Either<AppException, response.Response>> handleException<T extends Object>(Future<Response<dynamic>> Function() handler,
